"""
Django settings for wasanou project.
...
SECRET_KEY = 'django-insecure-q94)(qfycxof%6!pd%dnllw#%ljmaf!6!2au9-*ox$9a4zh)7%'
...
ROOT_URLCONF = "wasanou.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            BASE_DIR / "wasanou" / "templates",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "wasanou.wsgi.application"
